...
/**
 * Tests the {@link CleverMining} account type.
 */
class CleverMiningTest extends AbstractMiningPoolTest {

  function __construct() {
    parent::__construct(new \Account\MiningPool\CleverMining());
  }
  ...
  function getValidAccount() {
    return array(
      'api_key' => '1Q24z7gHPDbedkaWDTFqhMF8g7iHMehsCb',
    );
  }
  ...
  function getMissingAccount() {
    return array(
      'api_key' => '2Q24z7gHPDbedkaWDTFqhMF8g7iHMehsCb',
    );
  }
